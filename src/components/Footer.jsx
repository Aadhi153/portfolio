    ...
    <footer className="footer">
      <div className="container footer__inner">
        <div className="footer__brand">
          <div className="footer__logo-icon"><Code2 size={18} /></div>
          <span className="footer__logo-text">Dev<span>.Portfolio</span></span>
        </div>

        <p className="footer__copy">
          Made with <Heart size={13} className="footer__heart" /> by Aadhi Piranav · {new Date().getFullYear()}
        </p>
